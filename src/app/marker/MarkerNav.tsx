...
export default function MarkerNav() {
  ...
  const navLinks = [
    { href: "/marker/dashboard", label: "Dashboard", icon: "dashboard" },
    { href: "/marker/queue", label: "Review Queue", icon: "inbox" },
    { href: "/marker/reviews", label: "My Reviews", icon: "rate_review" },
  ];
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-white/10">
            <p className="text-xs text-gray-500 text-center">Marker Portal</p>
          </div>
        </div>
      </div>
    </>
